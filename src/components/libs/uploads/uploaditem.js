...
import UploadIcon from './upload-clound.png';
...
class ReactImageUploadComponent extends React.Component {
  ...
  onDropFile(e) {
    ...
    this.setState({notAcceptedFileType: [], notAcceptedFileSize:[]});
  ...
  render() {
    return (
      <div className={"fileUploader " + this.props.className} style={this.props.style}>
        <div className="fileContainerX" style={this.props.fileContainerStyle}>
          {this.renderIcon()}
          {this.renderLabel()}
